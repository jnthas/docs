...
**Explore:** Open up `post-service.html` to see how the component works. Internally, it uses the <code> <a href="../../elements/core-ajax.html">&lt;core-ajax&gt;</a></code> element to make HTTP requests.
{: .alert .alert-info}
